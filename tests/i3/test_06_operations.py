...
class TestMoveWizard:
    def test_move_operation_schema(
    ...
    def test_move_to_occupied_slot_fails(
        self, i3_client: httpx.Client, auth_headers: dict[str, str]
    ) -> None:
...
class TestOperationQueue:
    def test_jobs_endpoint_is_reachable(
        self, i3_client: httpx.Client, auth_headers: dict[str, str]
    ) -> None:
    ...
    def test_openblade_jobs_endpoint(
        self, i3_client: httpx.Client, auth_headers: dict[str, str]
    ) -> None:
